...
class PreviousLaunchesList extends StatefulWidget {
  @override
  _PreviousLaunchesListState createState() => _PreviousLaunchesListState();
}

class _PreviousLaunchesListState extends State<PreviousLaunchesList> {
  Future<LaunchesApi> futureLaunches;

  @override
  void initState() {
    if (fetchedPreviousLaunches != null)
      fetchedPreviousLaunches = fetchLaunches('previous', false, null);
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<LaunchesApi>(
      future: fetchedPreviousLaunches,
