        ...
        itemBuilder: (context, index) {
          return Container(
            ...
            decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(getWidth(context) / 70.0)),
            child: Container(
              margin: EdgeInsets.only(
                  ...
                  Container(
                    ...
                    child: Text(
                      IssDateParse().parse(DateTime.fromMillisecondsSinceEpoch(
                          snapshot.data.general['passes'][index]['startUTC'] *
                              1000)),
                      ...
                      children: [
                        ...
                        Text(
                          snapshot.data.general['passes'][index]
                                  ['startAzCompass'] +
                              '  ' +
                              snapshot.data.general['passes'][index]['startAz']
                                  .toString() +
                              '°',
                          style: GoogleFonts.poppins(
                              fontSize: 15.0,
