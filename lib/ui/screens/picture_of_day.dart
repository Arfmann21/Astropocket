...
import 'package:astropocket/ui/widgets/itself/apod/picture_day_image_widget.dart';
import 'package:astropocket/ui/widgets/itself/apod/picture_day_video_widget.dart';
            ...
            child: Column(
              children: [
                apodObject.type == 'video'
                    ? PictureDayVideoWidget()
                    : PictureDayImageWidget(),
