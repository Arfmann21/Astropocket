...
class MarsPhotos extends StatefulWidget {
  @override
  _MarsPhotosState createState() => _MarsPhotosState();
}

class _MarsPhotosState extends State<MarsPhotos> {
  @override
  void initState() {
                        ...
                        return Container(
                          ...
                          child: Card(
                            ...
                            child: CachedNetworkImage(
                              imageUrl: snapshot.data.general[index]['img_src']
                                  .toString()
