...
class NewsApi {
  ...
  NewsApi({this.title, this.thumbnail, this.websiteName, this.url, this.general});
...
Future<NewsApi> fetchNews(bool home) async {

  // try for network issues
  try {
    final response = home ?
        await http.get("https://spaceflightnewsapi.net/api/v1/articles?limit=1") : await http.get("https://spaceflightnewsapi.net/api/v1/articles?limit=1000");
