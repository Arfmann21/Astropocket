...
class SpecificColors {
  ...
  SpecificColors(BuildContext context) {
        ...
        backgroundColorAsScaffold = currentTheme.brightness == Brightness.light ? Color(0xFFFAFAFA) : Color(0xF031a30);
        ...
        timerBackgroundColor = currentTheme.brightness == Brightness.light ? Color.fromRGBO(33, 33, 33, 80) : Color.fromRGBO(28, 48, 70, 50);
        ...
        secondaryTextColor = currentTheme.brightness == Brightness.light ? Color(0xFF757575) : Color(0xFFb3b3b3);
        primaryTextColor = currentTheme.brightness == Brightness.light ? Color(0xFF2414C6B) : Color(0xFFbfbfbf);

        marsHighColor = currentTheme.brightness == Brightness.light ? Color(0xFFD58235) : Color(0xFFD58235);
